  ...
  return (
    <div className="space-y-6">
      <div className="bg-white border border-[#D9D9D9] rounded-2xl p-6">
        <h1 className="text-2xl font-bold text-[#353535]">Revision de Silabos</h1>
        <p className="text-[#6B7280] mt-1">Silabos entregados por los docentes para revision y aprobacion</p>
      </div>
      ...
      <Card className="border-[#D9D9D9]">
        <CardHeader className="pb-3">
          <CardTitle className="text-base flex items-center gap-2 text-[#353535]">
            <BookOpen className="w-4 h-4 text-[#3C6E71]" />
        ...
        <CardContent className="space-y-4">
          ...
          <div className="divide-y divide-[#F5F5F5]">
                ...
                <div key={i.id} className="py-3 flex flex-col sm:flex-row sm:items-center gap-3">
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-[#6B7280]">{i.docente} · {materia?.codigo}</p>
                    </div>
                  </div>
            ...
            {filtered.length === 0 && (
              <p className="py-8 text-center text-sm text-[#9CA3AF]">No se encontraron silabos.</p>
            )}
          </div>
        </CardContent>
      </Card>
